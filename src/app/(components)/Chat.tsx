...
export default function Chat() {
  ...
  return (
    <>
      <div className='flex flex-col w-full h-full p-3 overflow-y-auto overflow-x-hidden' style={{paddingTop: 'calc(4rem + env(safe-area-inset-top) + 0.75rem)', paddingBottom: '5.75rem'}}>
